...
export type Chapter = {
  ...
  nextChapterId: Maybe<Scalars['String']['output']>;
  orderIndex: Scalars['Float']['output'];
  prevChapterId: Maybe<Scalars['String']['output']>;
};
...
export type GetChapterQuery = { __typename?: 'QueryRoot', chapter: { __typename?: 'Chapter', id: string, chapterNumber: string, orderIndex: number, description: string | null, nextChapterId: string | null, prevChapterId: string | null, comic: { __typename?: 'Comic', id: string, slug: string | null, title: string, coverImage: string | null } | null, images: Array<{ __typename?: 'ChapterImage', url: string, w: number, h: number }> } | null };

export type GetCategoriesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCategoriesQuery = { __typename?: 'QueryRoot', categories: Array<{ __typename?: 'Category', id: string, name: string, slug: string, description: string | null }> };
